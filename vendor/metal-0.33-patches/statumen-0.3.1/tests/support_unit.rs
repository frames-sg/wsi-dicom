...
fn public_prelude_exports_common_reader_types() {
    ...
    let region = PreludeRegionRequest {
        scene: PreludeSceneId(0),
        series: PreludeSeriesId(0),
        level: PreludeLevelIdx(0),
        plane: PreludePlaneIdx::default(),
        origin_px: (0, 0),
        size_px: (16, 16),
    };
    let tile = PreludeTileRequest {
        scene: 0,
        series: 0,
        level: 0,
        plane: PreludePlaneSelection::default(),
        col: 0,
        row: 0,
    };
